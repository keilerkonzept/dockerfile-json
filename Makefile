...
README.md:
	go build -tags=dfrunsecurity github.com/keilerkonzept/$(APP) && <README.template.md subst \
...
binaries/osx_x86_64/$(APP): $(GOFILES)
	GOOS=darwin GOARCH=amd64 CGO_ENABLED=0 go build -tags=dfrunsecurity -ldflags "-X main.version=$(VERSION)" -o binaries/osx_x86_64/$(APP) .
...
binaries/windows_x86_64/$(APP).exe: $(GOFILES)
	GOOS=windows GOARCH=amd64 CGO_ENABLED=0 go build -tags=dfrunsecurity -ldflags "-X main.version=$(VERSION)" -o binaries/windows_x86_64/$(APP).exe .
...
binaries/linux_x86_64/$(APP): $(GOFILES)
	GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build -tags=dfrunsecurity -ldflags "-X main.version=$(VERSION)" -o binaries/linux_x86_64/$(APP) .
...
binaries/windows_x86_32/$(APP).exe: $(GOFILES)
	GOOS=windows GOARCH=386 CGO_ENABLED=0 go build -tags=dfrunsecurity -ldflags "-X main.version=$(VERSION)" -o binaries/windows_x86_32/$(APP).exe .
...
binaries/linux_x86_32/$(APP): $(GOFILES)
	GOOS=linux GOARCH=386 CGO_ENABLED=0 go build -tags=dfrunsecurity -ldflags "-X main.version=$(VERSION)" -o binaries/linux_x86_32/$(APP) .
...
binaries/linux_arm64/$(APP): $(GOFILES)
	GOOS=linux GOARCH=arm64 CGO_ENABLED=0 go build -tags=dfrunsecurity -ldflags "-X main.version=$(VERSION)" -o binaries/linux_arm64/$(APP) .
...
binaries/osx_arm64/$(APP): $(GOFILES)
	GOOS=darwin GOARCH=arm64 CGO_ENABLED=0 go build -tags=dfrunsecurity -ldflags "-X main.version=$(VERSION)" -o binaries/osx_arm64/$(APP) .
